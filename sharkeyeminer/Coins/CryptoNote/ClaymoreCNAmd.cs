...
namespace SharkEye.Coins.CryptoNote
{
    ...
    /// </summary>
    class ClaymoreCNAmd : MinerProgramBase
    {
        ...
        public override string MINERURL
        {
            get
            {
                return "https://github.com/nanopool/Claymore-XMR-Miner/releases/download/v10.2/Claymore.CryptoNote.AMD.GPU.Miner.v10.2.Beta.-.POOL.zip";
            }
        }
