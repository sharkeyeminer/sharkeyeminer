...
namespace SharkEye.Model
{
    ...
    {
        const string minerfileName = "sharkeyeminer.json";
        string m_filepath = "";
        ...
        {
            IFileIO fileio = null;
            fileio = new AppData("SharkEye", minerfileName);
            if (fileio.Verify())
                return fileio;
            fileio = new LocalFolder("SharkEye", minerfileName);
            if (fileio.Verify())
                return fileio;
